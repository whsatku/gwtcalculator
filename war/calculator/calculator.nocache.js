...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "calculator" because\n';
  ...
  $wnd.__gwt_activeModules['calculator'] = {
 ...
 * "/calculator.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['calculator'].superdevmode = true;

  var expectedSuffix = '/calculator.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + calculator + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:calculator';
  var devModeSessionKey = '__gwtDevModeSession:calculator';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/calculator/calculator.nocache.js';
  ...
  $wnd.__gwt_activeModules['calculator'].canRedirect = true;
  $wnd.__gwt_activeModules['calculator'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/calculator?user.agent=' + ua + '&_callback=' + callback;
