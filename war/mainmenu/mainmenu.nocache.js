...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "mainmenu" because\n';
  ...
  $wnd.__gwt_activeModules['mainmenu'] = {
    'moduleName' : 'mainmenu',
    'bindings' : function() {
      return {};
    }
 ...
 * "/mainmenu.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['mainmenu'].superdevmode = true;

  var expectedSuffix = '/mainmenu.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + mainmenu + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:mainmenu';
  var devModeSessionKey = '__gwtDevModeSession:mainmenu';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/mainmenu/mainmenu.nocache.js';
  ...
  $wnd.__gwt_activeModules['mainmenu'].canRedirect = true;
  $wnd.__gwt_activeModules['mainmenu'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/mainmenu?user.agent=' + ua + '&_callback=' + callback;
